          ...
          px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                ...
                to-sky-400 inline-flex font-bold uppercase tracking-widest text-sm text-transparent bg-clip-text gap-2 p-8">
                  ...
                  <h3 className="font-serif font-bold text-2xl mt-2 md:mt-5 md:text-4xl tracking-widest bg-gradient-to-r from-secondary to-primary text-transparent bg-clip-text">{project.title}</h3>
